...
(() => {
  ...
  const MAP_IMAGES = {
    ZE_AREALISTIC_DP: "assets/maps/ze_arealistic_dp.webp",
    ZE_ASTROEGYPT2: "assets/maps/ze_astroegypt2.webp",
    ZE_ASTROEGYPTT: "assets/maps/ze_astroegyptt.webp",
    ZE_ATIX_HELICOPTER: "assets/maps/ze_atix_helicopter.webp",
    ZE_ATIX_PANIC_V1_FIX: "assets/maps/ze_atix_panic_v1_fix.webp",
    ZE_BLACK_HAWK_V1: "assets/maps/ze_black_hawk_v1.webp",
    ZE_BLACK_TRAIN_V1: "assets/maps/ze_black_train_v1.webp",
    ZE_BOMBSHELTER_REDUX: "assets/maps/ze_bombshelter_redux.webp",
    ZE_CAMPESCAPE_B3: "assets/maps/ze_campescape_b3.webp",
    ZE_CAVE_V2_FINAL: "assets/maps/ze_cave_v2_final.webp",
    ZE_COUNTRYROADS: "assets/maps/ze_countryroads.webp",
    ZE_DEVELOPMENT: "assets/maps/ze_development.webp",
    ZE_FAILURES_ZONE: "assets/maps/ze_failures_zone.webp",
    ZE_FROSTWORLD_TG: "assets/maps/ze_frostworld_tg.webp",
    ZE_FTX_ESCAPE2_MA_FIX: "assets/maps/ze_ftx_escape2_ma_fix.webp",
    ZE_ICE_ESP_V1_FINAL: "assets/maps/ze_ice_esp_v1_final.webp",
    ZE_ICE4CAP_LG: "assets/maps/ze_ice4cap_lg.webp",
    ZE_JP4_REVERSE: "assets/maps/ze_jp4_reverse.webp",
    ZE_JURASSIC_BOAT_PG: "assets/maps/ze_jurassic_boat_pg.webp",
    ZE_JURASSICPARK_A1: "assets/maps/ze_jurassicpark_a1.webp",
    ZE_JURASSICPARK_LB: "assets/maps/ze_jurassicpark_lb.webp",
    ZE_JURASSICPARK_V5: "assets/maps/ze_jurassicpark_v5.webp",
    ZE_JURASSICPARK4: "assets/maps/ze_jurassicpark4.webp",
    ZE_KRUSTACIO_MG_FIX: "assets/maps/ze_krustacio_mg_fix.webp",
    ZE_MARIO_TOWER_LG: "assets/maps/ze_mario_tower_lg.webp",
    ZE_MILF_FACILITY_ESCAPE_FINAL_V4: "assets/maps/ze_milf_facility_escape_final_v4.webp",
    ZE_MINECRAFT_V1: "assets/maps/ze_minecraft_v1.webp",
    ZE_ROBLOX_LB: "assets/maps/ze_roblox_lb.webp",
    ZE_ROGERIA_JAIL_ARX: "assets/maps/ze_rogeria_jail_arx.webp",
    ZE_TIMEOFFEAR_ARXCS: "assets/maps/ze_timeoffear_arxcs.webp",
    ZE_WATERY_ESCAPE_V1: "assets/maps/ze_watery_escape_v1.webp"
  };
  ...
  function updateMapCard(mapName) {
    ...
    // Файла может ещё не быть — тогда остаётся заглушка NO IMAGE.
    image.onerror = () => {
      image.hidden = true;
      card.classList.remove("has-image");
    };
  ...
  function renderStatus(status) {
    ...
    document.title = status.serverOnline ? `[${online}/${status.maxPlayers}] KONTRA // ESCAPE` : "KONTRA // ESCAPE";
  ...
  async function shareSite() {
    ...
    const data = { title: "KONTRA // ESCAPE", text: "KONTRA // ESCAPE", url };
    try {
