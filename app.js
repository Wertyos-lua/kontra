/* KONTRA SITE v5 — LIVE PLAYER CARDS + GLOBAL TOP */
(() => {
  "use strict";
  ...
  const i18n = {
    en: {
      ...
      webControlHint: "Choose a section and the command will be delivered to your active game session.",
    ...
    ru: {
      ...
      webControlHint: "Выберите раздел — команда будет доставлена в вашу активную игровую сессию.",
  ...
  const CONTROL_PANELS = {
    lvl: {
      title: "LVL MOD",
      lead: "controlLvlLead",
      actions: [{ action: "open_lvl", icon: "◉", title: "openLvl", text: "openLvlText" }]
    },
    classes: {
      title: "CLASSES",
      lead: "controlClassesLead",
      actions: [
  ...
  function openControlPanel(panelName) {
    ...
    $("#controlModalLead").textContent = t(panel.lead);
  ...
  function setControlBusy(busy) {
    ...
    $$("#controlActions button").forEach((button) => { button.disabled = controlState.busy; });
  }
